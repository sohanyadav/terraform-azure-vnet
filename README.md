...
# Examples
For detailed examples on how to use this module, please refer to the [Example](https://github.com/sohanyadav/terraform-aws-vpc/tree/master/_example) directory within this repository.
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/sohanyadav/terraform-aws-vpc/blob/master/LICENSE) file for details.
